...
function run_mnist()
    ...
    # fit(m, TrainSet;n_iter=Epochs,lr=LearnRate,validation=ValidSet,n_gibbs=Gibbs)
    ...
    fit(mwdQuad, TrainSet;n_iter=Epochs,weight_decay="l2",decay_magnitude=0.001,lr=LearnRate,validation=ValidSet,n_gibbs=Gibbs)
    ...
    # fit(mwdLin, TrainSet;n_iter=Epochs,weight_decay="l1",decay_magnitude=0.001,lr=LearnRate,validation=ValidSet,n_gibbs=Gibbs)
