...
function run_mnist()
    ...
    fit(m, X;n_iter=Epochs,lr=0.005)
    ...
    fit(mwdQuad, X;n_iter=Epochs,weight_decay="l2",decay_magnitude=0.05,lr=0.005)
    ...
    fit(mwdLin, X;n_iter=Epochs,weight_decay="l1",decay_magnitude=0.05,lr=0.005)
