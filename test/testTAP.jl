...
function run_mnist()
    ...
    m1 = BernoulliRBM(28*28, HiddenUnits, (28,28); momentum=0.0, sigma=0.1)
    m2 = BernoulliRBM(28*28, HiddenUnits, (28,28); momentum=0.0, sigma=0.1)
    m3 = BernoulliRBM(28*28, HiddenUnits, (28,28); momentum=0.0, sigma=0.1)
    m4 = BernoulliRBM(28*28, HiddenUnits, (28,28); momentum=0.0, sigma=0.1)

    mM = BernoulliRBM(28*28, HiddenUnits, (28,28); momentum=0.0, dataset=X)
    ...
    tic()
    rbm2, _ = fit(m2, X; n_iter=Epochs,lr=LearningRate, approx="tap2", persistent=true, n_gibbs=3, weight_decay="l2",decay_magnitude=-0.001)
    toc()
    ...
    tic()
    rbm4,_ = fit(m4, X;n_iter=Epochs,lr=LearningRate, approx="CD",persistent=true, n_gibbs=1, weight_decay="l2",decay_magnitude=-0.001) #, weight_decay="l2",decay_magnitude=0.05)
    toc()
