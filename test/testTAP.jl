...
function run_mnist()
    ...
    m1 = BernoulliRBM(28*28, HiddenUnits; momentum=0.0)
    m2 = BernoulliRBM(28*28, HiddenUnits; momentum=0.0)
    m3 = BernoulliRBM(28*28, HiddenUnits; momentum=0.0)
    m4 = BernoulliRBM(28*28, HiddenUnits; momentum=0.0)
