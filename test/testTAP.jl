...
function run_mnist()
    ...
    m1 = BernoulliRBM(28*28, HiddenUnits; momentum=0.5, dataset=X)
    m2 = BernoulliRBM(28*28, HiddenUnits; momentum=0.5, dataset=X)
    m3 = BernoulliRBM(28*28, HiddenUnits; momentum=0.5, dataset=X)
    m4 = BernoulliRBM(28*28, HiddenUnits; momentum=0.5, dataset=X)
